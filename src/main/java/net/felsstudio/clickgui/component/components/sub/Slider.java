package net.felsstudio.clickgui.component.components.sub;
...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset + 8, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12,hovered ? Color.ORANGE.hashCode() : FenixVariableManager.mainColor.hashCode());
		GL11.glPushMatrix();
