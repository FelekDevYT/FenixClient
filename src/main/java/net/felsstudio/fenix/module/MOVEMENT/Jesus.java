...
public class Jesus extends Module {
    public Jesus(){
        ...
        ExampleMod.instance.settingsManager.rSetting(new Setting("Speed", this, 2.5, 1,8, false));
    }
            ...
            if (Objects.equals(Mode, "Matrix")) {
                if (Block.getIdFromBlock(block) == 9) {
                    if (!mc.player.onGround) {
                        speed(ExampleMod.instance.settingsManager.getSettingByName(this.name, "Speed").getValDouble());
